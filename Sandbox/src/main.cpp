...
//     int rateDeviceSuitability(vk::raii::PhysicalDevice const& device) {
...
//         bool hasGraphics = std::ranges::any_of(queueFamilies, [](auto const& qfp) {
//             return !!(qfp.queueFlags & vk::QueueFlagBits::eGraphics);
//         });

//         auto availableExtensions = device.enumerateDeviceExtensionProperties();
//         bool hasExtensions = std::ranges::all_of(requiredDeviceExtension, [&](auto const& required) {
//             return std::ranges::any_of(availableExtensions, [&](auto const& available) {
...
//         bool hasFeatures = features2.template get<vk::PhysicalDeviceVulkan13Features>().dynamicRendering;

//         if (!hasGraphics || !hasExtensions || !hasFeatures) {
//             return 0;
//         }
...
// 			if (score > 0)
// 			{
// 				candidates.push_back({score, device});
// 			}
// 		}
